	...
	<tbody>
		...
		<tr id='row-<?php echo $num_row?>'>
			...
			<td class='actions'>
				...
				<?php if(!$unset_delete){ ?>
					<?php if(strpos($_SERVER['REQUEST_URI'], 'employee_management') !== false ){ ?>
						<a onclick = "javascript: return delete_row('https://www.otikaapp.com/otikaAdmin/index.php/mainpanel/inactive_oneuser/<?php echo $row->idEmployee; ?>', '<?php echo $num_row?>')"
